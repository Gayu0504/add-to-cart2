                                        ...
                                        return (
                                            <tr key={i}>
                                               ...
                                               <td id={"price_" + i}><b> Price $</b> {product.price}</td>
                                                ...
                                                <td  >
                                                    <button type="button" onClick={(e) => decrease(e, product)} className="btn btn-danger border text-white">-</button>
                                                    {product.qty}
                                                <button type="button" onClick={(e) => increase(e, product)} className="btn btn-success border text-white">+</button>
                                                </td>
